...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "vscode-languageserver", "vscode-json-languageservice/lib/umd/services/jsonValidation", "../parser/jsonParser07", "../utils/textBuffer", "../parser/yaml-documents", "../utils/objects"], factory);
    }
        ...
        doValidation(textDocument, isKubernetes = false) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    console.error(objects_1.convertErrorToTelemetryMsg(err));
                }
                let previousErr;
